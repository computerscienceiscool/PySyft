...
Datasites enable data scientists to **answer questions** without even seeing or acquiring a copy of the data, **within the data owner's definition of acceptable use**. We call this process <b> Remote Data Science</b>.
